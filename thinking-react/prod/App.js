    ...
    _createClass(SearchBar, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                "form",
                null,
                React.createElement("input", { type: "text", placeholder: "Seacrh...", value: filterText, onChange: this.handleFilterTextChange }),
                React.createElement("br", null),
                React.createElement("input", { type: "checkbox", checked: inStockOnly, onChange: this.handleInStockChange }),
...
var FilterableProductTable = function (_React$Component5) {
    ...
    _createClass(FilterableProductTable, [{
        key: "handleFilterTextChange",
        value: function handleFilterTextChange(text) {
